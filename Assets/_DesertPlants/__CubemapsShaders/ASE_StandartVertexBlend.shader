...
Shader "ASE/ASE_StandartVertexBlend"
{
	Properties
	{
		...
		[ASEBegin]_HeightMapR("HeightMapR-----", 2D) = "white" {}
		...
		[ASEEnd]_TilingBase("TilingBase", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _HeightMapR_ST;
			float4 _HeightMapG_ST;
			...
			float _NormalDepthR;
			float _BlendFactorB;
			float _BlendContrastB;
			float _ParalaxOffsetB;
			float _TilingB;
			float _BlendFactorG;
			float _BlendContrastG;
			float _ParalaxOffsetG;
			float _TilingG;
			float _BlendFactorR;
			float _BlendContrastR;
			float _ParalaxOffsetR;
			float _TilingR;
			float _SmoothRoughB;
			float _SmoothStrB;
			...
			sampler2D _AlbedoR;
			sampler2D _HeightMapR;
			sampler2D _AlbedoG;
			sampler2D _HeightMapG;
			sampler2D _AlbedoB;
						...
						)
			{
				...
				float2 texCoord233 = packedInput.ase_texcoord5.xy * temp_cast_1 + float2( 0,0 );
				...
				float2 OffsetPOM98 = POM( _HeightMapR, texCoord233, ddx(texCoord233), ddy(texCoord233), normalWS, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetR ), 0.5, _HeightMapR_ST.xy, float2(0,0), 0 );
				...
				float HeightMask132 = saturate(pow(((clampResult134*packedInput.ase_color.r)*4)+(packedInput.ase_color.r*2),_BlendContrastR));
				...
				float4 lerpResult133 = lerp( tex2D( _AlbedoBase, texCoord17 ) , tex2D( _AlbedoR, OffsetPOM98 ) , temp_output_243_0);
				float2 temp_cast_3 = (_TilingG).xx;
				float2 texCoord235 = packedInput.ase_texcoord5.xy * temp_cast_3 + float2( 0,0 );
				float2 OffsetPOM212 = POM( _HeightMapG, texCoord235, ddx(texCoord235), ddy(texCoord235), normalWS, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetG ), 0.5, _HeightMapG_ST.xy, float2(0,0), 0 );
				...
				float HeightMask151 = saturate(pow(((clampResult150*packedInput.ase_color.g)*4)+(packedInput.ase_color.g*2),_BlendContrastG));
				...
				float2 texCoord237 = packedInput.ase_texcoord5.xy * temp_cast_5 + float2( 0,0 );
				float2 OffsetPOM213 = POM( _HeightMapB, texCoord237, ddx(texCoord237), ddy(texCoord237), normalWS, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetB ), 0.5, _HeightMapB_ST.xy, float2(0,0), 0 );
				...
				float HeightMask158 = saturate(pow(((clampResult157*packedInput.ase_color.b)*4)+(packedInput.ase_color.b*2),_BlendContrastB));
				...
				float3 unpack164 = UnpackNormalScale( tex2D( _NormalMapR, OffsetPOM98 ), _NormalDepthR );
				unpack164.z = lerp( 1, unpack164.z, saturate(_NormalDepthR) );
				float3 tex2DNode164 = unpack164;
				float3 unpack269 = UnpackNormalScale( tex2D( _NormalMapG, OffsetPOM212 ), _NormalDepthG );
				unpack269.z = lerp( 1, unpack269.z, saturate(_NormalDepthG) );
				float3 lerpResult169 = lerp( tex2DNode164 , unpack269 , temp_output_244_0);
				float3 unpack166 = UnpackNormalScale( tex2D( _NormalMapB, OffsetPOM213 ), _NormalDepthB );
				unpack166.z = lerp( 1, unpack166.z, saturate(_NormalDepthB) );
				float3 lerpResult170 = lerp( lerpResult169 , unpack166 , temp_output_245_0);
				
				float4 color185 = IsGammaSpace() ? float4(0,0,0,1) : float4(0,0,0,1);
				float3 temp_cast_8 = (color185.r).xxx;
				float3 temp_cast_9 = (color185.r).xxx;
				float3 linearToGamma175 = FastLinearToSRGB( temp_cast_9 );
				float3 linearToGamma176 = FastLinearToSRGB( tex2D( _SmoothR, OffsetPOM98 ).rgb );
				float3 temp_cast_13 = (( (( _SmoothRoughR )?( ( 1.0 - linearToGamma176.x ) ):( linearToGamma176.x )) * _SmoothStrR )).xxx;
				float3 lerpResult179 = lerp( linearToGamma175 , temp_cast_13 , temp_output_243_0);
				float3 linearToGamma177 = FastLinearToSRGB( tex2D( _SmoothG, OffsetPOM212 ).rgb );
				float3 temp_cast_17 = (( (( _SmoothRoughG )?( ( 1.0 - linearToGamma177.x ) ):( linearToGamma177.x )) * _SmoothStrG )).xxx;
				float3 lerpResult180 = lerp( lerpResult179 , temp_cast_17 , temp_output_244_0);
				float3 linearToGamma178 = FastLinearToSRGB( tex2D( _SmoothB, OffsetPOM213 ).rgb );
				float3 temp_cast_21 = (( (( _SmoothRoughB )?( ( 1.0 - linearToGamma178.x ) ):( linearToGamma178.x )) * _SmoothStrB )).xxx;
				float3 lerpResult181 = lerp( lerpResult180 , temp_cast_21 , temp_output_245_0);
				
				surfaceDescription.Albedo = lerpResult160.rgb;
				surfaceDescription.Normal = lerpResult170;
				...
				surfaceDescription.Smoothness = lerpResult181.x;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_cast_1 = (_TilingR).xx;
				float2 texCoord233 = packedInput.ase_texcoord.xy * temp_cast_1 + float2( 0,0 );
				...
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 OffsetPOM98 = POM( _HeightMapR, texCoord233, ddx(texCoord233), ddy(texCoord233), ase_worldNormal, ase_worldViewDir, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetR ), 0.5, _HeightMapR_ST.xy, float2(0,0), 0 );
				float4 tex2DNode122 = tex2D( _HeightMapR, OffsetPOM98 );
				float4 clampResult142 = clamp( ( tex2DNode122 + _BlendFactorR ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float clampResult134 = clamp( (clampResult142).r , 0.0 , 1.0 );
				float HeightMask132 = saturate(pow(((clampResult134*packedInput.ase_color.r)*4)+(packedInput.ase_color.r*2),_BlendContrastR));
				...
				float4 lerpResult133 = lerp( tex2D( _AlbedoBase, texCoord17 ) , tex2D( _AlbedoR, OffsetPOM98 ) , temp_output_243_0);
				float2 temp_cast_3 = (_TilingG).xx;
				float2 texCoord235 = packedInput.ase_texcoord.xy * temp_cast_3 + float2( 0,0 );
				float2 OffsetPOM212 = POM( _HeightMapG, texCoord235, ddx(texCoord235), ddy(texCoord235), ase_worldNormal, ase_worldViewDir, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetG ), 0.5, _HeightMapG_ST.xy, float2(0,0), 0 );
				float4 clampResult148 = clamp( ( tex2D( _HeightMapG, OffsetPOM212 ) + _BlendFactorG ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float clampResult150 = clamp( (clampResult148).r , 0.0 , 1.0 );
				float HeightMask151 = saturate(pow(((clampResult150*packedInput.ase_color.g)*4)+(packedInput.ase_color.g*2),_BlendContrastG));
				float4 temp_cast_4 = (HeightMask151).xxxx;
				...
				float4 lerpResult145 = lerp( lerpResult133 , tex2D( _AlbedoG, OffsetPOM212 ) , temp_output_244_0);
				float2 temp_cast_5 = (_TilingB).xx;
				float2 texCoord237 = packedInput.ase_texcoord.xy * temp_cast_5 + float2( 0,0 );
				float2 OffsetPOM213 = POM( _HeightMapB, texCoord237, ddx(texCoord237), ddy(texCoord237), ase_worldNormal, ase_worldViewDir, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetB ), 0.5, _HeightMapB_ST.xy, float2(0,0), 0 );
				float4 clampResult155 = clamp( ( tex2D( _HeightMapB, OffsetPOM213 ) + _BlendFactorB ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float clampResult157 = clamp( (clampResult155).r , 0.0 , 1.0 );
				float HeightMask158 = saturate(pow(((clampResult157*packedInput.ase_color.b)*4)+(packedInput.ase_color.b*2),_BlendContrastB));
				float4 temp_cast_6 = (HeightMask158).xxxx;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord233 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				...
				float2 texCoord235 = packedInput.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float2 OffsetPOM212 = POM( _HeightMapG, texCoord235, ddx(texCoord235), ddy(texCoord235), normalWS, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetG ), 0.5, _HeightMapG_ST.xy, float2(0,0), 0 );
				float3 unpack269 = UnpackNormalScale( tex2D( _NormalMapG, OffsetPOM212 ), _NormalDepthG );
				unpack269.z = lerp( 1, unpack269.z, saturate(_NormalDepthG) );
				float4 clampResult148 = clamp( ( tex2D( _HeightMapG, OffsetPOM212 ) + _BlendFactorG ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				...
				float2 texCoord237 = packedInput.ase_texcoord3.xy * temp_cast_3 + float2( 0,0 );
				float2 OffsetPOM213 = POM( _HeightMapB, texCoord237, ddx(texCoord237), ddy(texCoord237), normalWS, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetB ), 0.5, _HeightMapB_ST.xy, float2(0,0), 0 );
				float3 unpack166 = UnpackNormalScale( tex2D( _NormalMapB, OffsetPOM213 ), _NormalDepthB );
				unpack166.z = lerp( 1, unpack166.z, saturate(_NormalDepthB) );
				float4 clampResult155 = clamp( ( tex2D( _HeightMapB, OffsetPOM213 ) + _BlendFactorB ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				...
				float4 color185 = IsGammaSpace() ? float4(0,0,0,1) : float4(0,0,0,1);
				float3 temp_cast_5 = (color185.r).xxx;
				float3 temp_cast_6 = (color185.r).xxx;
				float3 linearToGamma175 = FastLinearToSRGB( temp_cast_6 );
				float3 linearToGamma176 = FastLinearToSRGB( tex2D( _SmoothR, OffsetPOM98 ).rgb );
				float3 temp_cast_10 = (( (( _SmoothRoughR )?( ( 1.0 - linearToGamma176.x ) ):( linearToGamma176.x )) * _SmoothStrR )).xxx;
				float4 tex2DNode122 = tex2D( _HeightMapR, OffsetPOM98 );
				float4 clampResult142 = clamp( ( tex2DNode122 + _BlendFactorR ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float clampResult134 = clamp( (clampResult142).r , 0.0 , 1.0 );
				float HeightMask132 = saturate(pow(((clampResult134*packedInput.ase_color.r)*4)+(packedInput.ase_color.r*2),_BlendContrastR));
				float4 temp_cast_11 = (HeightMask132).xxxx;
				float clampResult246 = clamp( CalculateContrast(_BlendContrastR,temp_cast_11).r , 0.0 , 1.0 );
				float temp_output_243_0 = ( clampResult246 * 1.0 );
				float3 lerpResult179 = lerp( linearToGamma175 , temp_cast_10 , temp_output_243_0);
				float3 linearToGamma177 = FastLinearToSRGB( tex2D( _SmoothG, OffsetPOM212 ).rgb );
				float3 temp_cast_15 = (( (( _SmoothRoughG )?( ( 1.0 - linearToGamma177.x ) ):( linearToGamma177.x )) * _SmoothStrG )).xxx;
				float3 lerpResult180 = lerp( lerpResult179 , temp_cast_15 , temp_output_244_0);
				float3 linearToGamma178 = FastLinearToSRGB( tex2D( _SmoothB, OffsetPOM213 ).rgb );
				float3 temp_cast_19 = (( (( _SmoothRoughB )?( ( 1.0 - linearToGamma178.x ) ):( linearToGamma178.x )) * _SmoothStrB )).xxx;
				float3 lerpResult181 = lerp( lerpResult180 , temp_cast_19 , temp_output_245_0);
		...
		Pass
		{
				...
				)
			{
				...
				float3 ase_tanViewDir =  tanToWorld0 * V.x + tanToWorld1 * V.y  + tanToWorld2 * V.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 OffsetPOM98 = POM( _HeightMapR, texCoord233, ddx(texCoord233), ddy(texCoord233), ase_worldNormal, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetR ), 0.5, _HeightMapR_ST.xy, float2(0,0), 0 );
				float3 unpack164 = UnpackNormalScale( tex2D( _NormalMapR, OffsetPOM98 ), _NormalDepthR );
				unpack164.z = lerp( 1, unpack164.z, saturate(_NormalDepthR) );
				float3 tex2DNode164 = unpack164;
				float2 temp_cast_1 = (_TilingG).xx;
				float2 texCoord235 = packedInput.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float2 OffsetPOM212 = POM( _HeightMapG, texCoord235, ddx(texCoord235), ddy(texCoord235), ase_worldNormal, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetG ), 0.5, _HeightMapG_ST.xy, float2(0,0), 0 );
				float3 unpack269 = UnpackNormalScale( tex2D( _NormalMapG, OffsetPOM212 ), _NormalDepthG );
				unpack269.z = lerp( 1, unpack269.z, saturate(_NormalDepthG) );
				float4 clampResult148 = clamp( ( tex2D( _HeightMapG, OffsetPOM212 ) + _BlendFactorG ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float clampResult150 = clamp( (clampResult148).r , 0.0 , 1.0 );
				...
				float2 temp_cast_3 = (_TilingB).xx;
				float2 texCoord237 = packedInput.ase_texcoord3.xy * temp_cast_3 + float2( 0,0 );
				float2 OffsetPOM213 = POM( _HeightMapB, texCoord237, ddx(texCoord237), ddy(texCoord237), ase_worldNormal, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetB ), 0.5, _HeightMapB_ST.xy, float2(0,0), 0 );
				float3 unpack166 = UnpackNormalScale( tex2D( _NormalMapB, OffsetPOM213 ), _NormalDepthB );
				unpack166.z = lerp( 1, unpack166.z, saturate(_NormalDepthB) );
				float4 clampResult155 = clamp( ( tex2D( _HeightMapB, OffsetPOM213 ) + _BlendFactorB ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float clampResult157 = clamp( (clampResult155).r , 0.0 , 1.0 );
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_cast_1 = (_TilingR).xx;
				float2 texCoord233 = packedInput.ase_texcoord7.xy * temp_cast_1 + float2( 0,0 );
				...
				float4 lerpResult133 = lerp( tex2D( _AlbedoBase, texCoord17 ) , tex2D( _AlbedoR, OffsetPOM98 ) , temp_output_243_0);
				float2 temp_cast_3 = (_TilingG).xx;
				float2 texCoord235 = packedInput.ase_texcoord7.xy * temp_cast_3 + float2( 0,0 );
				float2 OffsetPOM212 = POM( _HeightMapG, texCoord235, ddx(texCoord235), ddy(texCoord235), normalWS, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetG ), 0.5, _HeightMapG_ST.xy, float2(0,0), 0 );
				float4 clampResult148 = clamp( ( tex2D( _HeightMapG, OffsetPOM212 ) + _BlendFactorG ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float clampResult150 = clamp( (clampResult148).r , 0.0 , 1.0 );
				float HeightMask151 = saturate(pow(((clampResult150*packedInput.ase_color.g)*4)+(packedInput.ase_color.g*2),_BlendContrastG));
				...
				float4 lerpResult145 = lerp( lerpResult133 , tex2D( _AlbedoG, OffsetPOM212 ) , temp_output_244_0);
				float2 temp_cast_5 = (_TilingB).xx;
				float2 texCoord237 = packedInput.ase_texcoord7.xy * temp_cast_5 + float2( 0,0 );
				float2 OffsetPOM213 = POM( _HeightMapB, texCoord237, ddx(texCoord237), ddy(texCoord237), normalWS, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetB ), 0.5, _HeightMapB_ST.xy, float2(0,0), 0 );
				float4 clampResult155 = clamp( ( tex2D( _HeightMapB, OffsetPOM213 ) + _BlendFactorB ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float clampResult157 = clamp( (clampResult155).r , 0.0 , 1.0 );
				float HeightMask158 = saturate(pow(((clampResult157*packedInput.ase_color.b)*4)+(packedInput.ase_color.b*2),_BlendContrastB));
...
/*ASEBEGIN
Version=18900
234.6667;273.3333;1514.667;925;2180.98;2187.41;2.822125;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-1913.874,-713.0233;Float;False;Property;_ParalaxOffsetR;ParalaxOffsetR;7;0;Create;True;0;0;0;False;0;False;0.001;55.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;232;-2789.423,-1001.38;Float;False;Property;_TilingR;TilingR;11;0;Create;True;0;0;0;False;0;False;1;1.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;234;-2787.006,-832.1543;Float;False;Property;_TilingG;TilingG;22;0;Create;True;0;0;0;False;0;False;1;1.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;101;-1921.646,-2372.312;Float;True;Property;_HeightMapR;HeightMapR-----;0;0;Create;True;0;0;0;False;0;False;None;47777839017678447944013a095bc415;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;216;-1912.245,-618.0224;Float;False;Property;_ParalaxOffsetG;ParalaxOffsetG;19;0;Create;True;0;0;0;False;0;False;0.001;27.37;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;204;-1925.689,-2155.094;Float;True;Property;_HeightMapG;HeightMapG-----;12;0;Create;True;0;0;0;False;0;False;None;7361f61790beb65489777cf8d701c67c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;236;-2787.005,-691.938;Float;False;Property;_TilingB;TilingB;33;0;Create;True;0;0;0;False;0;False;1;0.94;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ParallaxOcclusionMappingNode;98;-992.1188,-946.053;Inherit;False;0;16;False;-1;64;False;-1;8;0.02;0.5;False;1,1;False;0,0;8;0;FLOAT2;0,0;False;1;SAMPLER2D;;False;7;SAMPLERSTATE;;False;2;FLOAT;0.02;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT2;0,0;False;6;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;217;-1905.744,-534.822;Float;False;Property;_ParalaxOffsetB;ParalaxOffsetB;30;0;Create;True;0;0;0;False;0;False;0.001;36.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;122;-939.8845,-1817.401;Inherit;True;Property;_HeightR;HeightR;3;0;Create;True;0;0;0;False;0;False;-1;c4f3287b294da494d9ebd0af390be9a6;6ff081746bc7b924c9f1d747cc6d715e;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;205;-1927.448,-1944.12;Float;True;Property;_HeightMapB;HeightMapB----;23;0;Create;True;0;0;0;False;0;False;None;6ff081746bc7b924c9f1d747cc6d715e;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ParallaxOcclusionMappingNode;212;-991.6548,-725.5938;Inherit;False;0;16;False;-1;64;False;-1;8;0.02;0.5;False;1,1;False;0,0;8;0;FLOAT2;0,0;False;1;SAMPLER2D;;False;7;SAMPLERSTATE;;False;2;FLOAT;0.02;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT2;0,0;False;6;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;221;-1395.211,-1861.878;Float;False;Property;_BlendFactorG;BlendFactorG;20;0;Create;True;0;0;0;False;0;False;0.5;-0.536;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;144;-928,-1568;Inherit;True;Property;_HeightG;HeightG;7;0;Create;True;0;0;0;False;0;False;-1;c4f3287b294da494d9ebd0af390be9a6;38f4e32d0db972740b0dd0418b09c79f;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;223;-1390.506,-1483.457;Float;False;Property;_BlendFactorB;BlendFactorB;31;0;Create;True;0;0;0;False;0;False;0.5;-0.217;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;146;-560,-1648;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;159;-932.8328,-1334.811;Inherit;True;Property;_HeightB;HeightB;11;0;Create;True;0;0;0;False;0;False;-1;c4f3287b294da494d9ebd0af390be9a6;12f1e3acbf51d2a4d8091ac5ec9a8e07;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;128;-1397.021,-2073.883;Float;False;Property;_BlendContrastR;BlendContrastR;8;0;Create;True;0;0;0;False;0;False;0.5;19.65;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;171;-464.2532,-133.1389;Inherit;True;Property;_SmoothR;SmoothR;3;0;Create;True;0;0;0;False;0;False;-1;None;5d655b6edb4ad914391608aa8426949c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;172;-525.7127,141.6703;Inherit;True;Property;_SmoothG;SmoothG;15;0;Create;True;0;0;0;False;0;False;-1;None;228cd316a300f2d409213b27c0bec57a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.HeightMapBlendNode;132;683.8633,-1838.503;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;222;-1393.544,-1760.282;Float;False;Property;_BlendContrastG;BlendContrastG;21;0;Create;True;0;0;0;False;0;False;0.5;17.03;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.HeightMapBlendNode;151;692.6326,-1640.552;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;173;-525.7127,365.6703;Inherit;True;Property;_SmoothB;SmoothB;26;0;Create;True;0;0;0;False;0;False;-1;None;6ff081746bc7b924c9f1d747cc6d715e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LinearToGammaNode;177;26.64871,184.1371;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.HeightMapBlendNode;158;699.2474,-1415.094;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;67;-2479.907,-1260.483;Float;False;Property;_TilingBase;TilingBase;40;0;Create;True;0;0;0;False;0;False;1;1.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;229;856.7388,52.77544;Float;False;Property;_SmoothStrR;SmoothStrR;5;0;Create;True;0;0;0;False;0;False;0.001;0.69;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;219;-266.7686,-433.3884;Float;False;Property;_NormalDepthG;NormalDepthG;17;0;Create;True;0;0;0;False;0;False;0.001;1.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;186;426.6486,440.1372;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;230;855.3679,214.7764;Float;False;Property;_SmoothStrG;SmoothStrG;18;0;Create;True;0;0;0;False;0;False;0.001;1.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1;-107.9713,-1181.106;Inherit;True;Property;_AlbedoR;AlbedoR;1;0;Create;True;0;0;0;False;0;False;-1;None;6a9094619052cc444a5e6b7c8813442b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;152;-319.7717,-2136.899;Inherit;True;Property;_AlbedoBase;AlbedoBase;37;0;Create;True;0;0;0;False;0;False;-1;None;691efe0801094b744b1dc929caf84014;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;218;-268.3976,-528.3894;Float;False;Property;_NormalDepthR;NormalDepthR;6;0;Create;True;0;0;0;False;0;False;0.001;1.39;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;121;-105.0141,-948.1488;Inherit;True;Property;_AlbedoG;AlbedoG;13;0;Create;True;0;0;0;False;0;False;-1;None;6562a3503e200144ea7b6a9b116dae04;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;231;853.8688,360.9376;Float;False;Property;_SmoothStrB;SmoothStrB;29;0;Create;True;0;0;0;False;0;False;0.001;0.67;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;269;375.8651,-748.1265;Inherit;True;Property;_NormalMapG;NormalMapG;14;0;Create;True;0;0;0;False;0;False;-1;None;20e0941de9986f14488245d251a61dcb;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;220;-260.2676,-350.188;Float;False;Property;_NormalDepthB;NormalDepthB;28;0;Create;True;0;0;0;False;0;False;0.001;1.28;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;164;388.56,-965.9499;Inherit;True;Property;_NormalMapR;NormalMapR;2;0;Create;True;0;0;0;False;0;False;-1;None;20e0941de9986f14488245d251a61dcb;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;166;397.5298,-517.3137;Inherit;True;Property;_NormalMapB;NormalMapB;25;0;Create;True;0;0;0;False;0;False;-1;None;17e69dc9773c0f446b1b9610f6720940;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;143;-133.7745,-735.8284;Inherit;True;Property;_AlbedoB;AlbedoB;24;0;Create;True;0;0;0;False;0;False;-1;None;f99a3df97a238c34ba81802982fa8ef1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;198;791.4489,598.4178;Inherit;False;Constant;_BaseMetall;BaseMetall;24;0;Create;True;0;0;0;False;0;False;0,0,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;200;1659.264,-408.4822;Float;False;Property;_Metall;Metall;39;0;Create;True;0;0;0;False;0;False;0.5;0.443;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LinearToGammaNode;191;1547.381,1050.499;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;196;1907.766,638.0982;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LinearToGammaNode;189;1531.381,618.4987;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LinearToGammaNode;190;1531.381,826.499;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;192;1229.36,614.1824;Inherit;True;Property;_MetallR;MetallR;34;0;Create;True;0;0;0;False;0;False;-1;None;6ff081746bc7b924c9f1d747cc6d715e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;174;-18.01654,-269.1476;Inherit;True;Property;_SmoothBase;SmoothBase;38;0;Create;True;0;0;0;False;0;False;-1;None;2a1ebe8fc965957408e1e0dd5b2059d2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;193;1243.381,826.499;Inherit;True;Property;_MetallG;MetallG;36;0;Create;True;0;0;0;False;0;False;-1;None;38f4e32d0db972740b0dd0418b09c79f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;195;2019.766,830.0985;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;197;1795.766,462.098;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;194;1243.381,1050.499;Inherit;True;Property;_MetallB;MetallB;35;0;Create;True;0;0;0;False;0;False;-1;None;989eb99c4864cf24cace422b6d37c75e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;195;2;158;0
WireConnection;197;0;198;0
WireConnection;197;1;189;0
WireConnection;197;2;132;0
WireConnection;107;0;160;0
WireConnection;107;1;170;0
WireConnection;107;4;200;0
WireConnection;107;7;181;0
ASEEND*/
//CHKSM=9A83A2B14F24F941FD9B01EABE0EB044037C7AFC